...
BEGIN
    ...
    VALUES( _idEmpresa, _idTipoDocumento, _idMunicipio, _idRol, _numeroDocumentoUsuario, _nombreUsuario, _apellidoUsuario, _correoUsuario, _telefonoUsuario, _direccionUsuario, _claveUsuario, _estadoUsuario);

    IF FOUND THEN
        RAISE NOTICE 'Se insertó correctamente el usuario';
        RETURN TRUE;
    ELSE
